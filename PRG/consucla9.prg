...
DO WHILE .NOT. EOF()
   ...
   *             123456798-123456    
   ...
   @LIN,44  SAY "0787" PICTURE "9999"
   @LIN,48  SAY "160"
   @LIN,51  SAY "1"
   *BASE DE CALCULO
   *             123456789-1234    
   *@LIN,51  SAY "00000000000.00"
   @LIN,52  SAY RETEN PICTURE "99999.99"
   *             123456789    
   *@LIN,52  SAY "123345.44"
   @LIN,66  SAY vvfecha picture "!!/!!/!!!!"
   @LIN,76  SAY "01"
   @LIN,78  SAY "0"
   @LIN,79  SAY RETEN PICTURE "99999.99"
   @LIN,93  SAY "000000"
   @LIN,99  SAY " "
   @LIN,109 SAY "86"
   @LIN,111 SAY CUIL
   @LIN,132 SAY "0000000000000"
   *@LIN,144 SAY " "
   *@LIN,174 SAY "0"
   *@LIN,175 SAY " "
   *@LIN,186 SAY " "  
